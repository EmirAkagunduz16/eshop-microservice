...
const ForgotPassword = () => {
  ...
  const onSubmitEmaill = ({ email }: { email: string }) => {
          ...
          {step === "email" && (
            <>
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                <p className="text-gray-500 text-center">Go back to? </p>
                <Link href={"/signup"} className="text-blue-500">
                  Login
                </Link>
              </div>

              <form action="" onSubmit={handleSubmit(onSubmitEmaill)}>
            ...
            <>
              ...
              {canResend ? (
                <button
                  ...
                  className="text-blue-500 cursor-pointer justify-center self-center"
                >
                  Resend OTP
                </button>
              ) : (
          ...
          {step === "reset" && (
            <>
              ...
              <form onSubmit={handleSubmit(onSubmitPassword)}>
                ...
                {serverError && (
                  <p className="text-red-500 tex-sm">{serverError}</p>
                )}
              </form>
            </>
          )}
