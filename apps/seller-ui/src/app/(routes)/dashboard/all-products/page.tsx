...
const ProductList = () => {
  ...
  return (
    <div className="w-ffull min-h-screen p-8">
      {/* Header */}
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-2xl font-semibold text-white">All Products</h1>
        <Link
          href={"/dashboard/create-product"}
          className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition flex justify-betwenn items-center gap-2"
        >
          <Plus size={18} />
          Add Product
        </Link>
